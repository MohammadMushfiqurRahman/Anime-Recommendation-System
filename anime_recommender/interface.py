...
def get_genre_recommendations(recommender):
    ...
    recommendations = recommender.get_recommendations_by_features(
        genres=genres, num_recommendations=num_recs
    )
...
def get_theme_recommendations(recommender):
    ...
    recommendations = recommender.get_recommendations_by_features(
        themes=themes, num_recommendations=num_recs
    )
...
def get_demographic_recommendations(recommender):
    ...
    recommendations = recommender.get_recommendations_by_features(
        demographics=[demographic], num_recommendations=num_recs
    )
...
def get_feature_recommendations(recommender):
    ...
    genres_input = input("Genres: ").strip()
    genres = (
        [genre.strip().lower() for genre in genres_input.split(",")]
        if genres_input
        else None
    )
    ...
    themes_input = input("Themes: ").strip()
    themes = (
        [theme.strip().lower() for theme in themes_input.split(",")]
        if themes_input
        else None
    )
